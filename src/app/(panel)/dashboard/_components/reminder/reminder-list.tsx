        ...
        <div className="flex flex-col gap-3">
            <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="txet-xl md:text-2xl font-bold">
                        Lembretes
                    </CardTitle>
                    ...
                    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                        ...
                        <DialogContent className="sm:max-w-[425px]">
                            <DialogHeader>
                                ...
                                <DialogDescription>Criar um novo lembrete par sua lista.</DialogDescription>
                ...
                <CardContent>
                    ...
                    {reminder.map((item) => (
                        ...
                        >
                            <p className="text-sm lg:text-base text-black font-bold">{item.description}</p>
                            <Button 
